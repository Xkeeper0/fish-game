...
-- these should probably be made better later
-- this largely just says "the water pool is a square"
-- "with this amount of air over it"
WATER_HEIGHT	= 32	-- "top" of water
WATER_DEPTH		= 140	-- "bottom" of water
